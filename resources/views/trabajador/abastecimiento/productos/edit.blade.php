...
@section('contenido')
    <div class="card">
        ...
        <div class="card-body">
            <h5 class="card-title"><u>.::Modificar Bebida</u></h5>
            <p class="card-text">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('nombre') is-invalid @enderror" id="nombre" name="nombre"
                            type="text" placeholder="Ingrese nombre" value="{{ $producto->nombre }}" required>
                        @error('nombre')
                        ...
                        <select name="idcategoria" id="idcategoria" class="form-control">
                            @foreach ($categorias as $row)
                                <option value="{{ $row['idcategoria'] }}"
                                    {{ $row['idcategoria'] == $producto['idcategoria'] ? 'selected' : '' }}>
                                    {{ $row['descripcion'] }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row pt-2">
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('p_costo') is-invalid @enderror" id="p_costo" name="p_costo"
                            type="number" min=".1" step=".1" placeholder="Ingrese precio costo"
                            value="{{ $producto->p_costo }}" required>
                        @error('p_costo')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row pt-2">
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('p_venta') is-invalid @enderror" id="p_venta" name="p_venta"
                            type="number" min=".1" step=".1" placeholder="Ingrese precio venta"
                            value="{{ $producto->p_venta }}" required>
                        @error('p_venta')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row pt-2">
                    <div class="col-md-6">
                        ...
                        <input class="form-control @error('stock') is-invalid @enderror" id="stock" name="stock"
                            type="number" min="0" step="1" placeholder="Ingrese stock" value="{{ $producto->stock }}"
                            required>
                        @error('stock')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
