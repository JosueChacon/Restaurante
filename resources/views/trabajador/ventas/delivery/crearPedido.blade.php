    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="frmPedido" action="{{ route('pedidos.store') }}" method="POST">
                ...
                <div class="row pt-2">
                    <div class="col-sm-2">
                        <a href="{{ route('home') }}" class='form-control btn btn-danger'><i class='fas fa-arrow-left'></i>
                            Cancelar</a>
                    </div>
                    <div class="col-sm-2">
                    ...
                    <input type="text" name="lugar" value="DELIVERY" hidden>
                </div>
                <div class="row pt-2">
                    <input hidden type="text" id="isDelivery" name="isDelivery" value="ok">
                </div>
            </form>
        </div>
    </div>
                            ...
                            @foreach ($productos as $f)
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <strong>Categoría : </strong> {{ $f->Categoria->descripcion }} <br>
                                        <strong>P. Venta : </strong>S/. {{ $f->p_venta }}<br>
                                        <strong>Stock : </strong><u>{{ $f->stock }}</u><br>
                                        <button type="button" id="btnpasar" class="btn btn-sm btn-warning"
...
@endsection
@section('script')
    <script src="/js/pedido-local.js"></script>
@endsection
