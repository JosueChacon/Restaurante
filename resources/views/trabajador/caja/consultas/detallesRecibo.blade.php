...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <input type="text" class="form-control text-right" value="S/.  {{number_format($recibo->total, 2)}}" readonly="readonly">
            </div>
        </div>
        <a href="{{route('recibos.index')}}" class="btn btn-danger"><i class="fas fa-arrow-left"></i>
            Volver</a>
    </div>
</div>
