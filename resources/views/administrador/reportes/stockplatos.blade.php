...
<body>
    <div class="container-fluid">
        <p class="encabezado">Reporte, Stock Actual de Platos</p>
        <div class="fuente">
            ...
            <p class="interlineado"><strong>Hora de programación:</strong> {{ $programacion->fecha->format('d/m/Y  h:i a') }}</p>
            <p class="interlineado"><strong>Total stock platos:</strong> {{ $total_platos }}</p>
        </div>
        <div class="fuente">
            <p>.::Productos</p>
        </div>
        <table class="table table-striped interlineado">
            <thead style="background-color: blue;">
                <tr class="fuente-tabla" style="color: white">
                    ...
                    <th style="width: 2cm">TipoPlato</th>
