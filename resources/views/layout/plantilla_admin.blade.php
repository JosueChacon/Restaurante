...
<head>
    ...
    <title>Restaurant .::Administrador</title>
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('programacion.index') }}"><i class="fas fa-check-circle"></i>
                        Programaciones</a>
                </li>
                <li class="nav-item">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('VerMostrador') }}" class="nav-link">
                        ...
                        <li class="nav-header text-white">COBRANZA</li>
                        <li class="nav-item">
                            <a href="{{ route('CobranzaPedidos') }}" class="nav-link">
